# Aquest fitxer conte tot el que es necessari per a la definicio d'un mapa de la ciutat
# - Definicio de la classe Station (estacio de Metro)
#	- Lectura de les informations de la BD:
#			 - information parada
#			 - information transbords i connexions de les linies.
#
# Autors:
# Grup:
